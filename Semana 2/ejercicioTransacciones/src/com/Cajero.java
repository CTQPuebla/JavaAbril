...
public class Cajero {
	...
	public void retirar(CuentaBasic cuenta, double monto) {
	...
	public void depositar(CuentaBasic cuenta, double monto) {
	...
	public void tranferir(CuentaBasic origen, CuentaBasic destino, double monto) {
	...
	public void consultarSaldoDisponible(CuentaBanc cuenta) {
